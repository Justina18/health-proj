  ...
  return (
    <div className='prem'>
      <div className='prem-head'>
        <div className='prem-head-img-holder' ><img className='prem-head-img' src='/Premium.png'  onClick={()=> navigate('/')}/></div>
        </div>
      ...
      <div className='prem-hold'>
          <h1 className='prem-h1' >
              Weekly Plans
             </h1> <RiVipCrown2Line  color='#D27245' fontSize={40}/>
             <p className='prem-p' >
          ...
          <h1 className='prem-h1' >
          Monthly Plan
             </h1> <RiVipCrown2Line  color='#9E9E9E' fontSize={40}/>
             <p className='prem-p' >
            The Health360 platform <br/> makes it possible for anyone with <br/> a smartphone or tablet to receive <br/> quality and affordable health <br/> consultation.
             </p>
             $500
          ...
          <h1 className='prem-h1' >
          Annual Plan
             </h1><RiVipCrown2Line  color='#FDD13F' fontSize={40}/>
