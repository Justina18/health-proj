    ...
    <div className='about'>
        ...
        <div className='about-wrap'>
            <div className='abt-text'>
                <p>
                    <b>Health360</b> is a healthcare solution aimed <br/> at providing all round quality healthcare <br/> through an app 
                </p>
            </div>
        ...
        <div className='why'>
            <div className='why-wrap'>
                ...
                <div className='why-hold'>
                    ...
                    <CgShapeZigzag fontSize={25}/>
                    <br/>
                    <p className='why-p' >With a wide range of <br/>  healthcare services to <br/>  choose from, you can <br/>  always find what you <br/>  need.</p>
                </div>
                ...
                <div className='why-hold'>
                    ...
                    <br/>
                    <p className='why-p' >
                    We take pride in <br/> ensuring all services <br/> rendered are done to <br/> perfection
                    </p>
                </div>
                ...
                <br/>
                    ...
                    <br/>
                    <p className='why-p' >
                    With doctors from  <br/> different countries, <br/> we ensure we always  <br/> have someone available  <br/> for you
                    </p>
                </div>
            </div>
        </div>
